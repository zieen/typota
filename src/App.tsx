...
function App() {
  const isPreviewOnly = useStore((state) => state.isPreviewOnly);
  ...
  return (
    <div className="flex flex-col h-screen w-full bg-neutral-900 overflow-hidden font-sans text-neutral-100">
      ...
      <main className="flex-1 flex overflow-hidden">
        ...
        <section className={`${isPreviewOnly ? 'w-full' : 'w-1/2'} min-w-[300px] h-full overflow-hidden bg-neutral-950 relative transition-all duration-300`}>
